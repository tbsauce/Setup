...
xfconf-query -c xfce4-panel -p "/panels/panel-1/background-image" -s "$HOME/Setup/Theme/Wallpapers/wallpaper2.png"

#Background Image
xfconf-query -c xfce4-desktop -p "/backdrop/screen0/monitorVirtual1/workspace0/last-image" -s "$HOME/Setup/Theme/Wallpapers/wallpaper1.jpg"
